const image = {
  ...
  iosWiget1: require('~/assets/images/iso-wiget1.svg').default,
  iosWiget2: require('~/assets/images/iso-wiget2.svg').default,
  chartInfo: require('~/assets/images/chart_info.svg').default,
